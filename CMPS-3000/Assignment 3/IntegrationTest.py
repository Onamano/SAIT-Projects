...
class TestIntegration(unittest.TestCase):
    ...
    def test_order_integration(self):
        #Verifies that the value returned for the order total is correct after the order list has had items added and removed.
        ...
        #Verifies all discount codes return the correct value.
